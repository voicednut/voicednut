...
class EnhancedDatabase {
    ...
    async createEnhancedTables() {
        ...
        const columnMigrations = [
            ...
            { sql: 'ALTER TABLE calls ADD COLUMN telegram_header_message_id INTEGER', column: 'telegram_header_message_id' },
            { sql: 'ALTER TABLE calls ADD COLUMN telegram_final_outcome_sent INTEGER DEFAULT 0', column: 'telegram_final_outcome_sent' },
            { sql: 'ALTER TABLE calls ADD COLUMN telegram_outcome TEXT', column: 'telegram_outcome' },
            { sql: 'ALTER TABLE calls ADD COLUMN has_recording INTEGER DEFAULT 0', column: 'has_recording' },
            { sql: 'ALTER TABLE calls ADD COLUMN has_transcript INTEGER DEFAULT 0', column: 'has_transcript' },
